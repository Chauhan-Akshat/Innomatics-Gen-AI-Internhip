...
FAQ_CONTENT = [
    ("SwiftCart E-Commerce Support Knowledge Base", None, "title"),
    ...
    ("Q: What payment methods do you accept?", "We accept all major credit and debit cards (Visa, Mastercard, RuPay), UPI (GPay, PhonePe, Paytm), net banking, EMI options, and SwiftCart Wallet. Cash on Delivery (COD) is available for orders under ₹5000 in select pin codes.", "qa"),
    ...
    ("Q: How does EMI work on SwiftCart?", "EMI is available on purchases above ₹3000 using select credit cards. At checkout, choose 'Pay via EMI', select your bank and tenure (3, 6, 9, or 12 months). No-cost EMI options are available on select products. Processing fees, if any, will be displayed before confirmation.", "qa"),
    ...
    ("Q: When will I receive my refund?", "After the returned item passes quality check (2–3 business days), refund is processed as follows: Original payment method: 5–7 business days. SwiftCart Wallet: instant. UPI: 1–3 business days. For COD orders, refund is credited to your bank account via NEFT within 7 days.", "qa"),
    ...
    ("Q: My account has been hacked or compromised.", "If you suspect unauthorized access, immediately click 'Forgot Password' to regain control. Then go to Settings > Security > Log Out All Devices. Review your recent orders for unauthorized purchases. Contact our fraud team at fraud@swiftcart.in immediately. Do not share your OTP or password with anyone, including our staff.", "qa"),
    ...
    ("Q: Can I contact the seller directly?", "You can message sellers via the product page > 'Ask a Question' or from your order page > 'Contact Seller'. Response time varies by seller, typically 24–48 hours. For urgent issues like delivery problems, always contact SwiftCart Support directly for faster resolution.", "qa"),

    ("6. Shipping & Delivery", None, "section"),
    ("Q: What are the delivery charges?", "Delivery is free for orders above ₹499. For orders below ₹499, a flat delivery fee of ₹40 applies. Express delivery (1–2 days) is available in metro cities for an additional ₹99. SwiftCart Plus members enjoy free delivery on all orders.", "qa"),
    ("Q: Do you deliver internationally?", "Currently, SwiftCart delivers only within India. We cover 27,000+ pin codes. For remote areas, delivery may take 7–10 business days. International shipping is on our roadmap for 2025.", "qa"),
    ...
    ("Q: What is SwiftCart Plus?", "SwiftCart Plus is our premium membership at ₹299/year or ₹49/month. Benefits include free delivery on all orders, early access to sales, exclusive member discounts, priority customer support, and free returns on all eligible products.", "qa"),

    ("7. Escalation & Complaints", None, "section"),
    ("Q: How do I escalate an unresolved issue?", "If your issue is not resolved within the promised timeline, you can escalate via: Live Chat > 'Escalate to Senior Agent', Email: escalation@swiftcart.in, or Call our senior support line at 1800-XXX-XXXX (Mon–Sat, 9AM–6PM). Escalated cases are resolved within 24 hours.", "qa"),
    ("Q: How do I file a formal complaint?", "For formal complaints, write to grievance@swiftcart.in with your order ID, issue description, and supporting documents. Our Grievance Officer will respond within 48 hours as per consumer protection regulations.", "qa"),
    ("Q: What if I want to report fraud or a scam?", "Report any fraud, phishing, or scam activity immediately to fraud@swiftcart.in or call our fraud hotline. Do not make any payments outside the SwiftCart platform. SwiftCart will never ask for your OTP, CVV, or net banking credentials.", "qa"),
]

def generate_pdf(output_path="data/swiftcart_support_kb.pdf"):

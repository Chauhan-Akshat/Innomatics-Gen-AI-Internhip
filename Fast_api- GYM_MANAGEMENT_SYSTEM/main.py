...
plans = [
    {"id": 1, "name": "Basic", "duration_months": 1, "price": 2000, "includes_classes": False, "includes_trainer": False},
    {"id": 2, "name": "Standard", "duration_months": 3, "price": 2900, "includes_classes": True, "includes_trainer": False},
    {"id": 3, "name": "Premium", "duration_months": 6, "price": 7100, "includes_classes": True, "includes_trainer": True},
    {"id": 4, "name": "Elite", "duration_months": 12, "price": 9280, "includes_classes": True, "includes_trainer": True},
    {"id": 5, "name": "Pro", "duration_months": 9, "price": 10100, "includes_classes": True, "includes_trainer": False},
]
...
@app.get("/")
def home():
    return {"message": "Welcome to Golds Gym"}
